...
const WhatsAppButton = ({ isSubmitClicked, handleSendWhatsApp }) => (
    <div className={`relative w-full ${!isSubmitClicked ? 'group' : ''}`}>
        <button
        ...
        {!isSubmitClicked && (
            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 w-max p-2 rounded-lg bg-black text-white text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
